...
def main(args):
    ...
    logger.info(f"data norm: {data_norm}, dki normalization type: {dki_norm_type}")
    #wmti scale type
    ...
    train_data, val_data, test_data = preprocess_datasets(datapath, mat_filename=dataset_fn, batch_size=batch_size, 
                                                    data_norm=data_norm, scale_type=scale_type, scale=out_scale, intercept=intercept, dki_scale_type=dki_norm_type) 
    ##
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", default='wmti_dkilr_constraint.mat', type=str)
    parser.add_argument("--datapath", default='/home/yujian/Desktop/cibmaitsrv1/DeepLearnings/whiteMatterModel', type=str)
    parser.add_argument("--model_folder", default='saveLSTM_96_scale1_dkilr_1e-3', type=str)
    ...
    parser.add_argument("--output_scale",  nargs="+", default=[100, 100, 100, 100, 1], type=int) #[100, 100, 100, 100, 100]#[100, 100, 100, 100, 1]#100
